...
function generateBaseProduct(productBaseCanId: number, base: BaseDTO, product: ProductDTO, can: number, unit: string, pricePerCan: number,
                             percentage: number, barCode: string): ProductBaseCanDTO {
  return {
  ...
  function getColorFromMapPrefill(_base: BaseDTO, _product: ProductDTO): string {
    let color = mapPrefillColor[generatePrefillComponentCode(_base, _product)];
